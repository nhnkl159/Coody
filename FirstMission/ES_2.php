...
class ES_2
{
	...
	public function AuthRequest($url)
  {
    ...
    $options = [
        CURLOPT_RETURNTRANSFER => true, // Sets the option to return transfer as string.
...
echo 'DataJson : </br> ' . $ourclass->DataJson(array("Example1", "Example2", "Example3")) . '</br> AuthRequest : </br>';
